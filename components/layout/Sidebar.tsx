    ...
    return (
        ...
        >
            ...
            <button
                ...
                className="fixed bottom-[24px] left-[228px] w-[24px] h-[24px] rounded-full bg-(--bg-elevated) border border-(--border-default) z-50 flex items-center justify-center text-(--text-secondary) hover:text-(--text-primary) hover:scale-110 shadow-sm transition-all duration-300 cursor-pointer"
                style={{
