...
import { Settings, Shield, Bell, CreditCard, Save, Globe, Database } from 'lucide-react'
                ...
                <div className="w-full md:w-[240px] shrink-0 flex flex-col gap-2">
                    {[
                        ...
                        <button
                            ...
                            className={cn("w-full flex items-center gap-3 px-4 py-3 rounded-[12px] font-bold text-[14px] transition-all", activeTab === tab.id ? "bg-red-600 text-white shadow-sm" : "bg-transparent text-(--text-secondary) hover:bg-[var(--bg-elevated)] hover:text-(--text-primary)")}
                        >
                            ...
                            <div>
                                ...
                                <div className="flex flex-col gap-4">
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <input type="text" defaultValue="SuperFit" className="h-[44px] px-4 rounded-[12px] bg-[var(--bg-elevated)] border border-(--border-default) focus:border-red-500 font-body text-[14px] outline-none w-full text-(--text-primary)" />
                                    </div>
                                    <div className="flex flex-col gap-2">
                                        <label className="font-body text-[13px] font-bold text-(--text-secondary)">Support Email</label>
                                        <input type="email" defaultValue="support@superfit.app" className="h-[44px] px-4 rounded-[12px] bg-[var(--bg-elevated)] border border-(--border-default) focus:border-red-500 font-body text-[14px] outline-none w-full text-(--text-primary)" />
                                    </div>
                            ...
                            <div className="flex justify-end pt-4 border-t border-(--border-subtle)">
                                <button 
                                    onClick={() => {
                                        ...
                                        setTimeout(() => toast.success('Platform configuration updated', { id }), 1200)
                                    }}
