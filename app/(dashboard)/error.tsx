  ...
  return (
    <div className="min-h-[50vh] flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-(--bg-surface) border border-(--border-subtle) rounded-[20px] p-6 text-center">
        ...
        <h2 className="font-display font-bold text-[20px] text-(--text-primary)">Dashboard failed to load</h2>
        <p className="mt-2 text-[14px] text-(--text-secondary)">Please retry this section.</p>
        <button
          onClick={reset}
